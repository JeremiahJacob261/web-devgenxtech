...
const projects = [
  ...
  },
  {
    ...
    description: "Scalable online shopping solution with advanced analytics, providing seamless user experience and robust backend support.",
  ...
  },
  {
    ...
    description: "Modern and secure banking interface designed to enhance user experience and streamline financial operations.",
  ...
  },
  {
    ...
    description: "End-to-end solution for managing investments and optimizing supply chain processes with advanced analytics.",
